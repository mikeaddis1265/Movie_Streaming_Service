...
export default function SubscriptionPage() {
  ...
  const loadPlans = async () => {
    try {
      ...
      if (response.ok) {
        ...
        const plansWithPopular = data.data.map(
  ...
  const handleSubscribe = async (planId: string) => {
    ...
    try {
      ...
      const response = await fetch(
        `/api/users/${session.user.id}/subscriptions/checkout`,
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({
      ...
      if (response.ok) {
        if (
          ...
          !data.data.checkout_url.includes("demo")
        ) {
        ...
        setError(
          data.error || "Failed to create subscription. Please try again."
        );
      }
    } catch (err) {
      console.error("Subscription error:", err);
      setError(
        "Failed to process subscription. Please check your connection and try again."
      );
    } finally {
      setSubscribing(null);
    }
  ...
  const handleSubscriptionAction = async (action: "cancel" | "resume") => {
    ...
    try {
      ...
      setError(
        `Failed to ${action} subscription. Please check your connection and try again.`
      );
    } finally {
      setSubscribing(null);
    }
    ...
    try {
      ...
      if (response.ok) {
        if (
          ...
          // Show success message
          setSuccessMessage(
            `Successfully upgraded to ${planName}! Your new plan is now active.`
          );
        ...
        setError(
          data.error || "Failed to upgrade subscription. Please try again."
        );
      }
    } catch (err) {
      console.error("Upgrade error:", err);
      setError(
        "Failed to process upgrade. Please check your connection and try again."
      );
    } finally {
      setSubscribing(null);
    }
  ...
  const handleDeleteSubscription = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Show success message
        setSuccessMessage(
          "Subscription deleted successfully. You now have access to free features only."
        );
      ...
      setError(
        "Failed to delete subscription. Please check your connection and try again."
      );
    } finally {
      setSubscribing(null);
    }
  ...
  const isCurrentPlan = (planName: string) => {
    return (
      userSubscription?.planName === planName &&
      ...
      <div className="subscription-hero">
        ...
        <div className="hero-content">
          ...
          <p className="hero-subtitle">
            Unlimited movies, TV shows, and exclusive content.
            <br />
        ...
        <div className="faq-section">
          ...
          <div className="faq-grid">
            <div className="faq-item">
              ...
              <p>
                Yes! Upgrade or downgrade at any time. Changes take effect at
            ...
            <div className="faq-item">
              ...
              <p>
                We offer a 7-day free trial for new subscribers. No credit card
                required to start.
              </p>
            </div>
            ...
            <div className="faq-item">
              ...
              <p>
                All major credit cards, PayPal, and local payment methods in
                your region.
              </p>
            </div>
          </div>
          ...
          <div className="cancel-dialog">
            ...
            <div className="dialog-body">
              ...
              <ul className="cancel-consequences">
                ...
                <li>
                  ! After the end date, you'll lose access to premium features
                </li>
              </ul>
            </div>
